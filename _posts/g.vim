...
silent only
cd ~/jekyll/al-folio-master/_posts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +9 2022-03-10-reversemapping.md
badd +0 sample-blog.md
argglobal
silent! argdel *
$argadd 2022-03-10-reversemapping.md
edit 2022-03-10-reversemapping.md
...
wincmd w
argglobal
if bufexists('sample-blog.md') | buffer sample-blog.md | else | edit sample-blog.md | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
